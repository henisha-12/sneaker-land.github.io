  ...
  <div class="container-scroller">
    ...
    <div class="horizontal-menu">
      ...
      <nav class="bottom-navbar">
        ...
        <!-- partial -->
        <a href="Add\add_package.php" class="add">
          +
        </a>
        ...
        <?php
          ...
          $q="select * from tbl_package  order by p_id desc";
                        ...
                        while($r=mysqli_fetch_array($result)){
                          echo "<tbody>
                            <tr>
                              ...
                              <td>$r[4]</td>
                              <td>$r[5]</td>
                              <td><a class='btn btn-inverse-primary btn-sm' href='Edit/Edit_Package.php?p_id=$r[0]'><i class='mdi mdi-pencil-circle-outline mdi-24px'></i></td>
                              <td><a class='btn btn-inverse-primary btn-sm' href='Delete/Delete_Package.php?p_id=$r[0]'><i class='mdi mdi-delete-empty mdi-24px'></td>
                            </tr>
                          </tbody>";
                        }
                        echo "</table>
