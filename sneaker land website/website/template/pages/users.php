    ...
    <div class="horizontal-menu">
      ...
      <nav class="bottom-navbar">
        ...
        <?php
          ...
          $q="select * from tbl_usr where type='user'  order by id desc";
                        ...
                        while($r=mysqli_fetch_array($result)){  
                          echo "<tbody>
                            <tr>
                              ...
                              <td>$r[4]</td>
                              <td>$r[5]</td>
                              <td><a class='btn btn-inverse-primary btn-sm' href='Delete/Delete_User.php?id=$r[0]'><i class='mdi mdi-delete-empty mdi-24px'></td>
                            </tr>
                          </tbody>";
                        }
                        echo "</table>
