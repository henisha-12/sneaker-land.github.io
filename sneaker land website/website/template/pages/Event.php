    ...
    <div class="horizontal-menu">
      ...
      <nav class="bottom-navbar">
        ...
        <?php
          ...
          $q="select * from tbl_event order by e_id desc";
                    ...
                    <div class='table-responsive'>
                      <table class='table table-hover'>
                        ...
                        while($r=mysqli_fetch_array($result)){
                          ...
                          echo "<tbody>
                            <tr>
                              <td><img src=$img style='width:100px !important;height: 100px !important;border-radius:0% !important' alt=$r[5]></td>
                              <td>$r[1]</td>
                              <td>$r[2]</td>
                              <td>$r[3]</td>
                              <td>$r[4]</td>
                              <td>$r[6]</td>
                              <td><a class='btn btn-inverse-primary btn-sm' href='Edit/Edit_Event.php?e_id=$r[0]'><i class='mdi mdi-pencil-circle-outline mdi-24px'></i></td>
                              <td><a class='btn btn-inverse-primary btn-sm' href='Delete/Delete_Event.php?e_id=$r[0]'><i class='mdi mdi-delete-empty mdi-24px'></td>
                            </tr>
                          </tbody>";
                        }
                        echo "</table>
