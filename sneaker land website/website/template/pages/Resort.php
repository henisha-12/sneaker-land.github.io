  ...
  <div class="container-scroller">
    ...
    <div class="horizontal-menu">
      ...
      <nav class="bottom-navbar">
        ...
        <!-- partial -->
        <a href="Add\add_resort.php" class="add">
          +
        </a>
        ...
        <?php
          ...
          $q="select * from tbl_resort  order by r_id desc";
                    ...
                    <div class='table-responsive'>
                      <table class='table table-hover'>
                        ...
                        while($r=mysqli_fetch_array($result)){  
                          $img = "../images/Resort/$r[5]";
                          echo "<tbody>
                            <tr>
                              <td><img src=$img style='width:100px !important;height: 100px !important;border-radius:0% !important' alt=$img></td>
                              <td>$r[1]</td>
                              <td>$r[2]</td>
                              <td>$r[3]</td>
                              <td>$r[4]</td>
                              <td><a class='btn btn-inverse-primary btn-sm' href='Edit/Edit_Resort.php?r_id=$r[0]'><i class='mdi mdi-pencil-circle-outline mdi-24px'></i></td>
                              <td><a class='btn btn-inverse-primary btn-sm' href='Delete/Delete_Resort.php?r_id=$r[0]'><i class='mdi mdi-delete-empty mdi-24px'></td>
                            </tr>
                          </tbody>";
                        }
                        echo "</table>
