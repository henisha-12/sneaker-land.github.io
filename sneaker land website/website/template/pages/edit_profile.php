                    ...
                    <div class='row'>
                      <div class='card-body'>
                        ...
                        <form action="" method="POST" enctype='multipart/form-data'>
                          <label for="unm">User Name</label><br>
                          <input class='form-control border-dark' value="<?= $r[2]; ?>" name="unm" type="text" id='unm' required/><br>
                          <label for="eml">Email</label><br>
                          <input class='form-control border-dark' value="<?= $r[1]; ?>" name="eml" type="email" id='eml' required/><br>
                          <label for="dob">Date of Birth</label><br>
                          <input class='form-control border-dark' value="<?= $r[4]; ?>" name="dob" type="date" id='dob' required/><br>
                          <label for="city">City</label><br>
                          <input class='form-control border-dark' value="<?= $r[5]; ?>" name="city" type="text" id='city' required/><br>                          
                          <input class='w-100 btn btn-inverse-primary btn-large btn-block' name="updt" id="updt" type="submit" value="Edit Profile">
                        </form>
                      </div>
                    </div>
                  </div>
...
<?php
        if (isset($_REQUEST['updt'])) {
          ...
          $dob=$_REQUEST['dob'];
          $city=$_REQUEST['city'];
          $q = "update tbl_usr set unm='$unm',email_id='$eml',dob='$dob',city='$city' where id=$id";
        //   echo $q;
          if (mysqli_query($mysql,$q)) {
            echo "<script type='text/javascript'>window.location.href='edit_profile.php'</script>";
