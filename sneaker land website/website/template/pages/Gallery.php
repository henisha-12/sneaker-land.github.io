  ...
  <div class="container-scroller">
    ...
    <div class="horizontal-menu">
      ...
      <nav class="bottom-navbar">
        ...
        <!-- partial -->
        <a href="Add\add_gallery.php" class="add">
          +
        </a>
                          ...
                          echo "<tbody>
                            <tr>
                              ...
                              if (str_contains($img,'.mp4')){
                                ...
                                echo "<td><img src=$img style='width:100px !important;height: 100px !important;border-radius:0% !important' alt=$r[1]></td>";
                              }
                              echo "<td><a class='btn btn-inverse-primary btn-sm' href='Edit/Edit_Gallery.php?g_id=$r[0]'><i class='mdi mdi-pencil-circle-outline mdi-24px'></i></td>
