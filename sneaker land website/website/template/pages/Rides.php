  ...
  <div class="container-scroller">
    ...
    <div class="horizontal-menu">
      ...
      <nav class="bottom-navbar">
        ...
        <!-- partial -->
        <a href="Add\add_ride.php" class="add">
          +
        </a>
                    ...
                    <div class='table-responsive'>
                      <table class='table table-hover'>
                        ...
                        while($r=mysqli_fetch_array($result)){
                          $img = "../images/Rides/$r[1]";
                          echo "<tbody>
                            <tr>
                              <td><img src=$img style='width:100px !important;height: 100px !important;border-radius:0% !important' alt=$r[2]></td>
                              <td>$r[2]</td>
                              ...
                              <td>$r[8]</td>
                              <td>$r[9]</td>
                              <td><a class='btn btn-inverse-primary btn-sm' href='Edit/Edit_Ride.php?ride_id=$r[0]'><i class='mdi mdi-pencil-circle-outline mdi-24px'></i></td>
                              <td><a class='btn btn-inverse-primary btn-sm' href='Delete\Delete_Ride.php?ride_id=$r[0]'><i class='mdi mdi-delete-empty mdi-24px'></td>
                            </tr>
                          </tbody>";
                        }
                        echo "</table>
