    ...
    <div class="boxed_wrapper">
        ...
        <section class="gallery-page-section">
            <div class="auto-container">
                ...
                <?php
                    require("connect.php");
                    $q="select * from tbl_photos where image like '%.mp4';";
                    ...
                    ?>
                            <div class="col-lg-4 col-md-6 col-sm-12 gallery-block">
                                <div class="gallery-block-two">
                                    <div class="inner-box">
                                        <figure class="image-box "><video src= <?php echo $img?> autoplay muted style="width:100%; height:200px"  alt=<?php echo $r[1]?>></figure>
