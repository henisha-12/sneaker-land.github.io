                        ...
                        <div class="form-inner">
                            <form method="post" id="contact-form" class="default-form" novalidate="novalidate">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                        <input type="text" name="unm" placeholder="User Name" value="<?php echo $r[2] ?>"  required="" aria-required="true">
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                        <input type="date" name="dob" placeholder="Date of Birth" value="<?php echo $r[4] ?>"  required="" aria-required="true">
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                        <input type="text" name="city" placeholder="City" value="<?php echo $r[5] ?>" required="" aria-required="true">
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-sm-12 form-group message-btn mr-0">
                                        <button class="theme-btn btn-one" type="submit" name="updt"><span>Edit Profile</span></button>
                                    </div>
                                    <span class="change"> Do you want to change your password? <a href="change_pass.php">Change Password</a></span>
                                </div>
                            </form>
                        </div>
                    </div>
