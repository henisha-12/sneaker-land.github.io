...
<body>
    ...
    <div class="boxed_wrapper">
                ...
                <div class="slide-item">
                    ...
                    <div class="auto-container">
                        <div class="content-box">
                            <h3>Explore Our Adventure Park</h3>
                            <h2>Where Thrills Await at Every Turn!</h2>
                        </div>
                    </div>
                </div>
                <div class="slide-item">
                    ...
                    <div class="auto-container">
                        <div class="content-box">
                            <h3>Explore Our Rides</h3>
                            <h2>Experience the thrill, enjoy the ride.</h2>
                        </div>
                    </div>
                </div>
                <div class="slide-item">
                    ...
                    <div class="auto-container">
                        <div class="content-box">
                            ...
                            <h2>Where Water and Thrills Collide!</h2>
                        </div>
                    </div>
                </div>
                <div class="slide-item">
                    <div class="image-layer" style="background-image:url(http://localhost/main_project/sneaker%20users/assets/images/banner/banner-4.jpg)"></div>
                    <div class="auto-container">
                        <div class="content-box">
                            <h3>Explore Our Resort</h3>
                            <h2>Your Ultimate Resort Retreat</h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="val_content">
                    <div class="val_content_inner">   
        <div class="sec-title centred">
                    <h2>beautiful!! <br />Sneaker Land </h2>
                </div>
                        <div class="row1">
                            <a href="all_ride.php">
                            ...
                            <a href="high_ride.php">
                            <div class="img_container">
                                <img src="assets\images\gallery\ride\freefall.jpg" alt="">
                                <span>High Thriller Rides</span>
                            </div>
                            </a>
                            <a href="thrill_ride.php">
                            <div class="img_container">
                                <img src="assets\images\gallery\ride\excited-black-woman-riding-car-in-amusement-park-e1645720200253.jpg" alt="">
                                <span>Family Rides</span>
                            </div>
                            </a>
                            <a href="kid_ride.php">
                            <div class="img_container last">
                                <img src="assets\images\gallery\ride\bumper-car.jpg" alt="">
