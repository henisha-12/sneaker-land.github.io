        ...
        <section class="animals-section sec-pad">
            <div class="auto-container">
                <div class="sec-title centred">
                    <h2>amazing Kiddie Rides <br />in our Restar Amusement park</h2>
                </div>
                <div class="tabs-box">
                    ...
                    <div class="tab-btn-box p_relative d_block mb_60 centred">
                        <div class="tab-btns tab-buttons centred">
                            <div class="row clearfix rd">
                                <?php
                                    require("connect.php");
                                    $q="select r.*, a.to_age, a.from_age from tbl_ride as r INNER JOIN tbl_age as a on r.age_id = a.age_id where r.type='Kiddi' order by r.ride_id desc;;";
                        ...
                        <img class="arrow-right" src="assets\images\arrow_right.png" alt="">
                                    ...
                                    <?php
                                        require("connect.php");
                                        $q="select r.*, a.to_age, a.from_age from tbl_ride as r INNER JOIN tbl_age as a on r.age_id = a.age_id where r.type='Kiddi';";
                                        $result=mysqli_query($mysql,$q) or die("Query Failed!!!".mysqli_error($mysql));
                                        if(mysqli_num_rows($result)>0){
                                            while($r=mysqli_fetch_array($result)){
